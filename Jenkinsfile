...
//        e.g https://github.com/thejohnpage/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/thejohnpage/events-app-api-server.git
//	    main
//      api-server-image
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/thejohnpage/events-app-api-server.git'
        ...
        stage('Deploy Image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials events-app-cluster --zone us-central1-c --project roidtc-octuser100'
            }
        }     
         stage('update k8s') {
             agent {
